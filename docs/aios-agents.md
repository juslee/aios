...
**Related:** [aios-ipc-syscalls.md](./aios-ipc-syscalls.md) — IPC and syscall interface, [aios-spaces.md](./aios-spaces.md) — Space storage, [aios-subsystem-framework.md](./aios-subsystem-framework.md) — Hardware abstraction, [aios-networking.md](./aios-networking.md) — Network Translation Module
