...
**Related:** [aios-ipc-syscalls.md](./aios-ipc-syscalls.md) — IPC fast path and direct switch, [aios-compositor.md](./aios-compositor.md) — Compositor frame deadlines, [aios-airs.md](./aios-airs.md) — Inference scheduling, [aios-memory.md](./aios-memory.md) — Per-agent memory, [aios-agents.md](./aios-agents.md) — Agent CPU quotas
