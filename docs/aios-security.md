...
**Related:** [aios-subsystem-framework.md](./aios-subsystem-framework.md) — Capability gate, [aios-airs.md](./aios-airs.md) — Intent verification, behavioral monitoring, [aios-spaces.md](./aios-spaces.md) — Encryption, provenance, [aios-ipc-syscalls.md](./aios-ipc-syscalls.md) — Syscall validation
