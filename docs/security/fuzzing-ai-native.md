...
**Related:** [fuzzing-hardening-strategies.md](./fuzzing-hardening-strategies.md) — Hardening strategies, [fuzzing-adoption-roadmap.md](./fuzzing-adoption-roadmap.md) — Phased adoption, [fuzzing-tooling.md](./fuzzing-tooling.md) — Tooling and catalog
...
### 7.2 Kernel-Internal AI (Frozen Models, Phase 13+)
...
### 7.3 AIRS-Dependent Security (Phase 8+)
...
Cross-reference: [security.md](security.md) §2 (eight security layers), [airs.md](../intelligence/airs.md) §5.9 (capability intelligence).
