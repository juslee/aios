...
Agents never hold raw key material. All cryptographic operations happen in the kernel (or TrustZone in Phase 35+). The kernel exposes a small set of crypto syscalls:
...
### 5.4 TrustZone Integration (Phase 35)
...
**Timeline:** TLA+ models begin in Phase 18 (Security Architecture). Coq proofs for capability system and provenance chain target Phase 35. Full formal verification of W^X and IPC also targeting Phase 35.
