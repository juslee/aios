...
| [fuzzing-hardening-strategies.md](fuzzing-hardening-strategies.md) | §3 | Hardening strategies: language safety, syscall validation, memory, IPC, drivers, manifests, concurrency |
| [fuzzing-adoption-roadmap.md](fuzzing-adoption-roadmap.md) | §4 | Phased fuzzing adoption from host-side (Phase 0) through formal verification (Phase 24) |
| [fuzzing-tooling.md](fuzzing-tooling.md) | §5, §6 | Tiered tooling strategy (3 tiers) and fuzz target catalog |
| [fuzzing-ai-native.md](fuzzing-ai-native.md) | §7 | AI-native fuzzing: development-time tools, kernel-internal models, AIRS-dependent defense |
...
| §3.1–3.6 | [fuzzing-hardening-strategies.md](fuzzing-hardening-strategies.md) | Language, syscall, memory, IPC, driver, manifest hardening |
| §3.7 | [fuzzing-hardening-strategies.md](fuzzing-hardening-strategies.md) | Concurrency hardening (ARM ordering, Loom, controlled scheduling) |
| §4.1 | [fuzzing-adoption-roadmap.md](fuzzing-adoption-roadmap.md) | Phases 0–2: host-side fuzzing |
| §4.2 | [fuzzing-adoption-roadmap.md](fuzzing-adoption-roadmap.md) | Phases 3–5: syscall/IPC fuzzing + stateful techniques |
| §4.3 | [fuzzing-adoption-roadmap.md](fuzzing-adoption-roadmap.md) | Phase 4: storage fuzzing |
| §4.4–4.7 | [fuzzing-adoption-roadmap.md](fuzzing-adoption-roadmap.md) | Phases 6–24: compositor, network, agent, full campaign, formal verification |
| §5.1–5.3 | [fuzzing-tooling.md](fuzzing-tooling.md) | Tiered tooling strategy (Tier 1–3) |
| §5.4 | [fuzzing-tooling.md](fuzzing-tooling.md) | Corpus management |
| §6 | [fuzzing-tooling.md](fuzzing-tooling.md) | Fuzz target catalog (22 targets) |
| §7.1 | [fuzzing-ai-native.md](fuzzing-ai-native.md) | Development-time AI tools |
| §7.2 | [fuzzing-ai-native.md](fuzzing-ai-native.md) | Kernel-internal AI (frozen models) |
| §7.3 | [fuzzing-ai-native.md](fuzzing-ai-native.md) | AIRS-dependent security |
