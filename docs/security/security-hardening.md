...
**Related:** [security-layers.md](./security-layers.md) — Layer 6 (cryptographic enforcement), [security-capabilities.md](./security-capabilities.md) — Capability system, [security-operations.md](./security-operations.md) — Event response, audit
**See also:** [memory-hardening.md](../kernel/memory-hardening.md) — W^X/PAC/BTI/MTE kernel implementation, [fuzzing-and-hardening.md](./fuzzing-and-hardening.md) — Fuzzing deep-dive, [static-analysis.md](./static-analysis.md) — Static analysis and formal verification deep-dive
