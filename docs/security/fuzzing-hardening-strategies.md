...
**Related:** [fuzzing-adoption-roadmap.md](./fuzzing-adoption-roadmap.md) — Phased adoption, [fuzzing-tooling.md](./fuzzing-tooling.md) — Tooling and catalog, [fuzzing-ai-native.md](./fuzzing-ai-native.md) — AI-native strategies
...
No syscall implementation trusts any user-supplied value without validation. This is enforced by code review (see [security.md](security.md) §8.1 agent audit tool) and by syscall fuzzing ([fuzzing-adoption-roadmap.md](fuzzing-adoption-roadmap.md) §4.2).
