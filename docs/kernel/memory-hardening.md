...
**Related:** [memory-physical.md](./memory-physical.md) — Buddy and slab allocators, [memory-virtual.md](./memory-virtual.md) — Page tables and W^X, [security.md](../security/security.md) — Security model
