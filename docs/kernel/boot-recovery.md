...
**Related:** [boot-kernel.md](./boot-kernel.md) — Kernel early boot, [boot-services.md](./boot-services.md) — Service startup, [boot-performance.md](./boot-performance.md) — Boot timing
