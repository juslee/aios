...
**Related:** [boot-kernel.md](./boot-kernel.md) — Kernel early boot, [boot-lifecycle.md](./boot-lifecycle.md) — Shutdown and implementation order
...
| `IpcSubsystem`, `ChannelId`, health check protocol | [ipc.md](./ipc.md) | Health check protocol (boot-services.md §4.4) and Service Manager IPC channels (ipc.md §4.1) must match ipc.md's channel semantics. |
