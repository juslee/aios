...
**Related:** [boot-kernel.md](./boot-kernel.md) — Kernel early boot, [boot-services.md](./boot-services.md) — Service startup phases, [compositor.md](../platform/compositor.md) — Display handoff
