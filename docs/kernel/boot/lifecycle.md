...
**Related:** [suspend.md](./suspend.md) — Suspend/resume, [testing.md](./testing.md) — Test strategy, [services.md](./services.md) — Service startup
...
The boot sequence maps to the earliest development phases. Week ranges below match the canonical durations in overview.md §10. These are *development plan* phases, not boot phases — see services.md §4-5 for runtime boot phases.
