...
| `CapabilityManager`, `CapabilityToken`, root capability, trust levels, `Capability::Root` | [model.md](../../security/model.md) §10 | `Timestamp::MAX` for Trust Level 0 tokens (Step 12) and capability delegation model (model.md §3.5) must stay aligned. |
