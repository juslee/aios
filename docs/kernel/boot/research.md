...
**Related:** [kernel.md](./kernel.md) — Kernel early boot, [suspend.md](./suspend.md) — Suspend/resume, [intelligence.md](./intelligence.md) — Boot intelligence, [lifecycle.md](./lifecycle.md) — Implementation order
...
1. **Boot trace recording.** Every boot records a compact trace of non-deterministic events: timer interrupts, device responses, MMIO reads, scheduling decisions. The trace is stored in the panic dump partition (recovery.md §8.2) — available before Space Storage starts.
