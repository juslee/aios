...
**Related:** [boot.md](./boot.md) — Boot sequence and platform detection, [device-model.md](./device-model.md) — Device model and driver framework, [subsystem-framework.md](../platform/subsystem-framework.md) — Userspace device management, [scheduler.md](./scheduler.md) — Timer and GIC integration
