...
**Related:** [boot-firmware.md](./boot-firmware.md) — Firmware handoff and BootInfo, [boot-services.md](./boot-services.md) — Service startup, [boot-performance.md](./boot-performance.md) — Boot timing, [hal.md](./hal.md) — Platform trait, [memory.md](./memory.md) — Memory management
