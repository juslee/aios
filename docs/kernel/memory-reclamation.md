...
**Related:** [memory-physical.md](./memory-physical.md) — Physical memory and pools, [memory-virtual.md](./memory-virtual.md) — Per-agent memory, [memory-ai.md](./memory-ai.md) — Model memory and KV caches
...
pub fn handle_page_fault(
    ...
    match pte.state() {
        ...
        // Case 4: COW page (handled in [§5.4](./memory-virtual.md))
