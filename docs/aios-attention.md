...
**Related:** [aios-airs.md](./aios-airs.md) — Urgency inference and summarization, [aios-context-engine.md](./aios-context-engine.md) — Context-aware filtering, [aios-experience.md](./aios-experience.md) — Attention Panel UI, [aios-agents.md](./aios-agents.md) — Agent attention posting, [aios-security.md](./aios-security.md) — Capability enforcement
