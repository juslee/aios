...
**Related:** [aios-security.md](./aios-security.md) — Capability system and trust boundaries, [aios-spaces.md](./aios-spaces.md) — Space sharing and provenance, [aios-networking.md](./aios-networking.md) — Peer protocol and credential isolation, [aios-agents.md](./aios-agents.md) — Agent identity and delegation, [aios-airs.md](./aios-airs.md) — Relationship-aware AI behavior
