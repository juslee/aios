...
The wireless subsystem is implemented in Phase 18 (WiFi, Bluetooth & Wireless — 5 weeks), building on Phase 17 (USB Stack & Hotplug) for USB dongle support.

```text
Phase 18 M1:  WiFi Foundation
...
Phase 18 M2:  Bluetooth Foundation
