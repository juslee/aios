...
- **AIRS-dependent intelligence (§14):** Features requiring semantic understanding, LLM reasoning, or continuous learning. These require the AIRS runtime (Phase 10+) and degrade gracefully if AIRS is unavailable.
