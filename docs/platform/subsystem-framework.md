...
**Related:** [device-model.md](../kernel/device-model.md) — Device model and driver framework, [networking.md](./networking.md), [audio.md](./audio.md), [gpu.md](./gpu.md), [power-management.md](./power-management.md), [posix.md](./posix.md)
