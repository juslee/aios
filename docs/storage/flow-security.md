...
**Related:** [flow-data-model.md](./flow-data-model.md) — Capability types, [flow-integration.md](./flow-integration.md) — Cross-agent flow, [security.md](../security/security.md) — System security model
