...
**Related:** [spaces-block-engine.md](./spaces-block-engine.md) — Block Engine (§4.10 Device Encryption), [spaces-data-structures.md](./spaces-data-structures.md) — Core Data Structures, [spaces-sync.md](./spaces-sync.md) — Space Sync
