...
**Related:** [spaces-block-engine.md](./spaces-block-engine.md) — Block Engine (zone allocation, compression), [spaces-versioning.md](./spaces-versioning.md) — Version Store (retention policies)
...
All ML-driven storage features integrate through AIRS (Phase 8+):
