...
**Related:** [flow-transforms.md](./flow-transforms.md) — Transform engine, [flow-history.md](./flow-history.md) — History storage, [spaces-data-structures.md](./spaces-data-structures.md) — Space types referenced by Flow
...
pub struct Transfer {
    ...
    /// Current state.
    /// Future: progressive delivery (§16.8 in flow-extensions.md) adds a
...
pub struct TypedContent {
    ...
    /// Future: lazy materialization (§16.7 in flow-extensions.md) replaces
...
pub struct ContentPayload {
    ...
    /// Future: scatter-gather delivery (§16.10 in flow-extensions.md) may
...
pub enum SemanticType {
    ...
    /// Dispatchable action (see §15.8 in flow-extensions.md).
...
pub struct ContentMetadata {
    ...
    /// runs (see §15.6 in flow-extensions.md). Custom types have this set
