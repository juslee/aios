...
pub trait FlowClient: Send + Sync {
    ...
    /// Register an action handler for SemanticType::Action content (§15.8 in extensions.md).
    ...
    /// Future: per-subscriber queues (§16.11 in extensions.md) add
...
/// (see SemanticType::Action in data-model.md §3.4).
