...
**Related:** [aios-ipc-syscalls.md](./aios-ipc-syscalls.md) — Syscall interface and POSIX translation table, [aios-subsystem-framework.md](./aios-subsystem-framework.md) — PosixBridge trait and /dev nodes, [aios-spaces.md](./aios-spaces.md) — Space-to-path mapping, [aios-flow.md](./aios-flow.md) — Clipboard POSIX bridge
