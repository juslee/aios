...
**Related:** [aios-ipc-syscalls.md](./aios-ipc-syscalls.md) — IPC shared memory, [aios-airs.md](./aios-airs.md) — Model memory and KV caches, [aios-development-plan.md](./aios-development-plan.md) — Phase 2
