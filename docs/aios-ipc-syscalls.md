...
**Related:** [aios-compositor.md](./aios-compositor.md) — Compositor protocol, [aios-subsystem-framework.md](./aios-subsystem-framework.md) — Subsystem sessions
...
See [aios-compositor.md](./aios-compositor.md) for the full protocol. The compositor uses the same IPC channel pattern as all other services.
