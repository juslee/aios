...
**Parent document:** [aios-architecture.md](./aios-architecture.md) — Section 6.1 Boot Sequence
**Related:** [aios-ipc-syscalls.md](./aios-ipc-syscalls.md) — IPC and syscalls, [aios-spaces.md](./aios-spaces.md) — Space Storage, [aios-airs.md](./aios-airs.md) — AI Runtime Service, [aios-development-plan.md](./aios-development-plan.md) — Phase plan
