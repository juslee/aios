...
| §2 Architecture | `platform/compositor.md` §9, `applications/ui-toolkit.md` §12 |
...
| §9 Accessibility Tree | `platform/compositor/security.md` §11, `applications/ui-toolkit.md` §12 |
