...
**Related:** [aios-compositor.md](./aios-compositor.md) — Compositor protocol, [aios-experience.md](./aios-experience.md) — Experience layer surfaces, [aios-agents.md](./aios-agents.md) — Agent SDK, [aios-flow.md](./aios-flow.md) — Flow drag/drop integration, [aios-context-engine.md](./aios-context-engine.md) — Context-aware adaptation
