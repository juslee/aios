...
**Kit overview:** [AIRS Kit](../kits/intelligence/airs.md) — Inference engine, model registry, intelligence services orchestration
...
| [behavioral-monitor.md](./behavioral-monitor.md) | — | **Standalone:** Full behavioral monitor architecture (hub + 7 sub-docs). Detection, profiling, evasion resistance, AI intelligence |
...
| [tool-manager.md](./tool-manager.md) | All | Tool Manager hub — registry, execution pipeline, sandboxing, interop, security, AI-native intelligence (dedicated architecture doc) |
