...
**Related:** [aios-airs.md](./aios-airs.md) — Behavioral inference, [aios-context-engine.md](./aios-context-engine.md) — Context-driven preference adaptation, [aios-experience.md](./aios-experience.md) — Conversation Bar configuration, [aios-spaces.md](./aios-spaces.md) — Preference storage and sync, [aios-agents.md](./aios-agents.md) — Agent preference scoping
