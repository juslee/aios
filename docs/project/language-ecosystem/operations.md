...
- No ptrace equivalent exists until Phase 23 (POSIX layer)
- No debug wire protocol (Chrome DevTools Protocol, DAP) until Phase 17+ SDK tooling

**Practical debugging workflow (Phase 17):**
...
**Full debugging (Phase 23+):** Once the POSIX layer is available, GDB server support enables
