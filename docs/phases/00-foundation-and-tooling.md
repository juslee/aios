...
**Key reference:** [boot-kernel.md](../kernel/boot-kernel.md) §3.3 Steps 1-2 document the FPU enable and VBAR install sequence. Phase 0 implements a subset of this; the full UEFI handoff and `BootInfo` assembly is Phase 1 work.
